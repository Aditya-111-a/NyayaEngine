...
MATCH (c:Chapter {chapter_key:"CPA_2019::CH1"})
WITH d, c

// Section 1
MERGE (s1:Section {section_key:"CPA_2019::S_1"})
SET s1.doc_id = "CPA_2019",
    s1.section_no = "1",
    s1.title = "Short title, extent, commencement and application",
    s1.text = "
...
MERGE (c)-[:HAS_SECTION]->(s1)

// Section 2
MERGE (s2:Section {section_key:"CPA_2019::S_2"})
SET s2.doc_id = "CPA_2019",
    s2.section_no = "2",
    s2.title = "Definitions",
    s2.text = "
